...
namespace iviu96afa\admin\models\searchs;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use iviu96afa\admin\models\Menu as MenuModel;

/**
 * Menu represents the model behind the search form about [[\iviu96afa\admin\models\Menu]].
 * 
